...
RateContainer.prototype = {
  ...
  initUpdate: function (id) {
    ...
    $('input[name="container_rate"]').unbind();
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        if (_rateContainer == undefined || !_rateContainer.rate_container_id) {
          ...
          $('input[name="container_rate"]').prop('readonly', true);
          ...
          // $('input[name="container_rate"]').val(
          //   numeral(_depotinvoice.invoice_price).value()
          // );

          $('input[name="container_cost"]').val(
            numeral(_rateContainer.container_cost).value()
          );

          $('input[name="rate_container_margin"]').val(
            numeral(_rateContainer.rate_container_margin).value()
          );

          $('input[name="container_rate"]').val(
            numeral(_rateContainer.container_rate).value()
          );
  ...
  formValidateOption: {
    ...
    rules: {
      ...
      container_cost: { required: true },
      rate_container_margin: { required: true },
      container_sku: {
        required: false,
        maxlength: 300,
        remote: {
    ...
    submitHandler: function (form) {
      ...
      _f_data.container_cost = numeral(_f_data.container_cost).value();
      _f_data.rate_container_margin = numeral(_f_data.rate_container_margin).value();
      _f_data.container_rate = numeral(_f_data.rate_container_margin).value() + numeral(_f_data.container_cost).value();
