   ...
   formValidateOption: {
      ...
      submitHandler: function (e) {
         ...
         _f_data.primary_phone = $("#register_form #table_phone .primary_phone").val();
          if(_f_data.primary_phone.match(/\d/g).length===10){
              _f_data.primary_phone = _f_data.primary_phone.replace(/\D/g,'');
              _f_data.primary_phone = _f_data.primary_phone.slice(0,3) + _f_data.primary_phone.slice(3,6)+_f_data.primary_phone.slice(6,10);
          }else{
              _f_data.primary_phone = ''
          }
