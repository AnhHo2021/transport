                    ...
                    <div class=" col col-12">
                        <table id="depot-tbl" class="table your-cart no-footer">
                            ...
                            <tr>
                                ...
                                <td style="width: 150px; text-align: center">Min cost</td>
                                <td style="width: 150px; text-align: center">Delivery cost</td>
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB_JIUARZ0WQeJIIjdzL-uU9P7L72GowXM&v=weekly"
    defer >
</script>