 ...
 <fieldset>
    <div class="row">
        ...
        SmartForm::print_field(
            ...
            12,
            true,
            hasPermission($product_form, 'SKU', 'show')
        ) .
        SmartForm::print_field(
            'prod_name',
            SmartForm::FORM_FIELD_INPUT,
            ...
            12,
            true,
            hasPermission($product_form, 'prod_name', 'show')
        ) .

        '<div class="col col-12 dropdown-p" tabindex="-1"> </div>' .
        SmartForm::print_field(
            'prod_desc',
            ...
            12,
            true,
            hasPermission($product_form, 'prod_desc', 'show')
        ) .
        SmartForm::print_field(
            'prod_desc_short',
            SmartForm::FORM_FIELD_TEXTAREA,
            ...
            12,
            true,
            hasPermission($product_form, 'prod_desc_short', 'show')
        ) .
        '
        </section>
        ...
        SmartForm::print_field(
            ...
            12,
            true,
            hasPermission($product_form, 'prod_photo', 'show')
        )
    ...
    if (isAdmin()) {
        $body_product .= SmartForm::print_field(
            ...
            6,
            true,
            hasPermission($product_form, 'prod_cost', 'show')
        );
    }
    $body_product .= SmartForm::print_field(
        'prod_price',
        ...
        6,
        true,
        hasPermission($product_form, 'prod_price', 'show')
    ) . '
    </div>
    <div class="row">' .
        SmartForm::print_field(
            ...
            3,
            true,
            hasPermission($product_form, 'prod_weight', 'show')
        ) .
        SmartForm::print_field(
            'prod_length',
            SmartForm::FORM_FIELD_INPUT,
            ...
            3,
            true,
            hasPermission($product_form, 'prod_length', 'show')
        ) .
        SmartForm::print_field(
            'prod_width',
            SmartForm::FORM_FIELD_INPUT,
            ...
            3,
            true,
            hasPermission($product_form, 'prod_width', 'show')
        ) .
        SmartForm::print_field(
            'prod_height',
            SmartForm::FORM_FIELD_INPUT,
            ...
            3,
            true,
            hasPermission($product_form, 'prod_height', 'show')
        ) .
        SmartForm::print_field('product_qty', SmartForm::FORM_FIELD_INPUT, array(
            'label' => 'Product Quantity',
            'class' => 'product-qty',
            // 'attr' => array('readonly="false"'),
        ), 6, true, hasPermission($product_form, 'product_qty', 'show')) .
        '</div>
        <div class="row">';
...
<script>
    ...
    <?php if (isset($productEdit->ID)) {
        echo 'new ControlPage("#product-form-control");';
    } ?>
</script>