        ...
        <div>
            <div class="widget-body no-padding">
                ...
                <form class="smart-form" id="ratecontainer_form" method="post">
                        ...
                        <div class="row">
                            <?php if (hasPermission($ratecontainer_form, 'vendor_id', 'show')) { ?>
                                <section class="col col-6">
                                    <label class="input">Company Name <span class="link_to" data-view="link_to"
                                            data-form="#ratecontainer_form" data-control="company_name"
                                            data-name="company-form" data-param="id"></span></label>
                            ...
                            <?php if (hasPermission($ratecontainer_form, 'depot_id', 'show')) { ?>
                                <section class="col col-6">
                                    <label class="input">Depot Name <span class="link_to" data-view="link_to"
                                            data-form="#ratecontainer_form" data-control="depot_name" data-name="depot-form"
                            ...
                            <?php if (hasPermission($ratecontainer_form, 'container_type_id', 'show')) { ?>
                                <section class="col col-6">
                                    <label class="input">Container Type <span class="link_to" data-view="link_to"
                                            data-form="#ratecontainer_form" data-control="container_type_name"
                                    ...
                                    <select name="container_type_name" id="container_type_name" class="form-control"
                                        style="width:100%" <?php (!hasPermission($ratecontainer_form, 'container_type_id', $ratecontainer_current_form) ? ' disabled="disabled' : '') ?>></select>
                                </section>
                    ...
                    <fieldset style="border-top: none; padding-top: 10px">
                        <div class="row">
                            <?= SmartForm::print_field('rate_container_margin', SmartForm::FORM_FIELD_INPUT, array(
                                ...
                                'attr' => array(
                                    ...
                                    hasPermission($ratecontainer_form, 'rate_container_margin', $ratecontainer_form) ? '' : 'readonly="true"',
                                ),
                                'class' => 'input-currency currency' . (!hasPermission($ratecontainer_form, 'rate_container_margin', $ratecontainer_current_form) ? '" readonly="true' : ''),
                            ), 6, true, hasPermission($ratecontainer_form, 'rate_container_margin', 'show')) ?>
                            ...
                            <?= SmartForm::print_field('container_cost', SmartForm::FORM_FIELD_INPUT, array(
                                ...
                                'attr' => array(
                                    ...
                                    'number-to-fixed="2"',
                                    'data-number-stepfactor="100"',
                                    hasPermission($ratecontainer_form, 'container_cost', $ratecontainer_form) ? '' : 'readonly="true"',
                                ),
                                'class' => 'input-currency currency' . (!hasPermission($ratecontainer_form, 'container_cost', $ratecontainer_current_form) ? '" readonly="true' : ''),
                    ...
                    <fieldset style="border-top: none; padding-top: 10px">
                        <div class="row">
                            <?php if ($ratecontainer_current_form == 'edit') { ?>
                                <?= SmartForm::print_field('container_rate', SmartForm::FORM_FIELD_INPUT, array(
                                    ...
                                    'class' => 'input-currency currency' . (!hasPermission($ratecontainer_form, 'container_rate', $ratecontainer_current_form) ? '" readonly="true' : ''),
