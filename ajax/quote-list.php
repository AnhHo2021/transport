	...
	<div class="row" id="order-list-content">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" data-widget-editbutton="false">
				<header>
               <h2><i class="fa fa-table"></i> Quote list </h2>
					<?php if(canAddForm('OrderForm')){ ?>

               <a href="./#ajax/quote-form.php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Create new Order</a>
					<?php }?>
				</header>
				<div class="">
                        ...
                        <div class="fs m-t10 m-b25 order-content smart-form">
                            <section>
                                ...
                                <div class="row m-b5 search">
                                    ...
                                    <div class="col col-1">
                                        <input type="number" class=" form-control line-nuber" value="10">
                                    </div>
                                    <div class="col col-1">
...
<script src="<?php echo ASSETS_URL; ?>/js/script/quote-list.js"></script>
