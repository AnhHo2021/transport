    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-md-12 col-6">
                ...
                <input type="text" class="form-control datetimepicker" name="pay_date" id="pay_date">
            </section>
        </div>
        <div class="row">
            <section class="col col-md-12 col-6">
                <label class="label">Note</label>
                <textarea type="text" class="form-control" name="pay_note" id="pay_note" rows="4"></textarea>
            </section>
        </div>
    </fieldset>
</div>
